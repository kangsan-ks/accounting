...
@include('m/inc/sub_header_m')
    <div class="sub_content m_ed02">    
        <div class="sub_sub_title inner">
            ...
            <a href="" class="erp_download">주문신청서 다운로드<img src="/img/m_download.png" alt="download"></a>
        </div>
        <div class="edu_board_list">
            <ul>
                <li>
                    <div class="list_title flex_box_left f_v_center">
                        <h4>품질관리ERP 지원 신청합니다.</h4>
        ...
        <div class="edu_board_view">                    
            <ul>
                <li>
                    <h3 class="inner">품질관리ERP 지원 신청합니다.</h3>
                ...
                <li>
                    <div class="file inner">
                        <img src="/img/m_download.png" alt="download">품질관리ERP 지원 신청서_홍길동.docx
                    </div>   
                </li>
                <li class="inner">
                    품질관리ERP 지원 신청합니다. 품질관리ERP 지원 신청합니다. 품질관리ERP 지원 신청합니다. 품질관리ERP 지원 신청합니다. 품질관리ERP 지원 신청합니다. 품질관리ERP 지원 신청합니다. 품질관리ERP 지원 신청합니다. 품질관리ERP 지원 신청합니다. 품질관리ERP 지원 신청합니다. 품질관리ERP 지원 신청합니다. 품질관리ERP 지원 신청합니다. 품질관리ERP 지원 신청합니다. 품질관리ERP 지원 신청합니다. 품질관리ERP 지원 신청합니다. 품질관리ERP 지원 신청합니다. 품질관리ERP 지원 신청합니다. 품질관리ERP 지원 신청합니다. 품질관리ERP 지원 신청합니다. 
