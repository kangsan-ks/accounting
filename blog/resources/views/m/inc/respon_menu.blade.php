...
<div class="re_main_menu ">
    <div class="header_box">           
        <div class="inner header_top flex_box_bet f_v_center">     
        {{-- <form action="" method="GET">
            <label for="search">검색창</label>
            <input type="text" class="search" name="" placeholder="검색어를 입력해주세요.">
    ...
    <ul class="m_ship flex_box_bet f_v_center inner">
        <li class="login on"><a href="/m/m_login">로그인</a></li>
        <li><a href="/m_join/join">회원가입</a></li>
    </ul>
    <ul class="re_main_menu_list inner">
        <li> 
            <div class="main_title flex_box_bet f_v_center">
                <a href="">협의회소개</a>
                <div class="re_main_down">
                    <img src="/img/m_down_btn.png" alt="" class="nomal_img">
                    <img src="/img/m_down_btn_on.png" alt="" class="on_img_none">
                </div>   
            </div> 
