        ...
        <form action="/FAction/join" method="post" name="joinF" onsubmit="return frm_chk();">
            ...
            <ul>
                ...
                <li class="line_2">
                    ...
                    <div class="inp_box">
                        <input type="text" name="m_addr1" class="address" id="sample6_address" onclick="sample6_execDaumPostcode();" required>
                        <input type="text" name="m_addr2" class="address" id="sample6_detailAddress" placeholder="(상세주소)" required>
                    </div>
                </li>  
                ...
                <li>
                    ...
                    <div class="inp_box">
                        ...
                        <select name="m_level" id="" required>
                            <option value="" disabled selected >회계사 회원 등급</option>
                            <option value="1">법인정회원</option>
                            <option value="2">준회원</option>
                            <option value="3">예비회원</option>
                        </select>
                    </div>
                </li>    
            </ul>
            ...
            <div class="submit_box flex_box_cen">
                ...
                <input type="reset" class="reset goBackPage" value="취소"/>
            </div>            
        </form>
    </div>
</div>
